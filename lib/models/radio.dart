...
class MyRadio {
  ...
  @override
  String toString() {
    return 'MyRadio(id: $id, order: $order, name: $name, tagline: $tagline, color: $color, description: $description, url: $url, category: $category, icon: $icon, image: $image, lang: $lang)';
  }
